...
parser.add_argument('--weight_decay', type=float, default=0.0, help="the weight decay of optimizer")
...
test_users, ground_true_items = dataset.get_test_data()
# get mask matrix for test
mask_matrix = dataset.create_mask_matrix()
...
for epoch in range(args.epochs):
    # training
    trainer.train_an_epoch(train_data, epoch_id=epoch)
    # testing
    trainer.evaluate(test_data, ground_true_items, mask_matrix, epoch_id=epoch)
